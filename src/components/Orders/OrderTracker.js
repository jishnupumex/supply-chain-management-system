...
const OrderTracker = () => {
  return (
    ...
    <li class="relative w-full sm:mb-6 ">
        <div class="flex items-center">
            ...
            <div class="flex w-full bg-green-600 h-0.5 dark:bg-gray-700"></div>
        </div>
        <div class="mt-3">
    ...
    <li class="relative w-full mb-6">
        ...
        <div class="mt-3">
            <h3 class="font-medium text-gray-900 dark:text-white">Shipped</h3>
        </div>
    </li>
    <li class="relative w-full sm:mb-6">
        <div class="flex items-center">
        ...
        <div class="mt-3">
            <h3 class="font-medium text-gray-900 dark:text-white">Out For Delivery</h3>
        </div>
    </li>
    <li class="relative w-full mb-6">
        <div class="flex items-center">
        ...
        <div class="mt-3">
            <h3 class="font-medium text-gray-900 dark:text-white">Delivered</h3>
        </div>
    </li>
</ol>
  )
